...
object NBSProto {
    ...
    fun handleFrom(
        ...
        Device.parseSMSPacket(phone, buffer)
        ...
        //     true
        // )
        // Stats.increment(STAT.STAT_NBS_RCVD);
    }
    ...
    //             val fromAddr = CommsAddrRec(elem.phone!!, elem.port.toInt())
    //             Device.parseSMSPacket(fromAddr, elem.data!!)
