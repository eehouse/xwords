...
## I'm rewriting a significant portion of the codebase to move functionality from Android into the cross-platform layer, which should make it much easier to support new platorms (e.g. iOS).
...
builds as I push them. Installing CrossDbg is the best way to keep up
